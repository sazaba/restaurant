...
const Product = ({ pizza }) => {
    ...
    return (
        <div className='min-h-screen flex'>
            ...
            <div className='basis-2/4 p-[20px]'>
                ...
                <h3 className='font-bold text-xl my-4'>Choose The Size</h3>
                <div className='flex justify-between w-[40%] cursor-pointer'>
                ...
                <h3 className='font-bold text-xl my-4'>Choose Aditional Ingredients</h3>
                ...
                <div className='my-4'>
                    ...
                    <button className='h-[30px] px-2 ml-3 bg-red-600 text-white border-none cursor-pointer font-[500]'>Add to Cart</button>
                </div>
