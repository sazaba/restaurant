...
const PizzaCard = ({ pizza }) => {
    return (
        <div className='w-[100%] p-3 flex flex-col items-center justify-center px-[20px] py-[40px] cursor-pointer lg:w-[33%]'>
            ...
            <p className='text-[24px] text-center text-gray-500'>{pizza.desc}</p>
        </div>
    )
}
